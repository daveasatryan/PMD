...
class __$$InitialDataImplCopyWithImpl<$Res>
    extends _$ProductListStateCopyWithImpl<$Res, _$InitialDataImpl>
...
class _$InitialDataImpl implements _InitialData {
  const _$InitialDataImpl({required final List<ProductModel> productList})
  ...
  @override
  String toString() {
    return 'ProductListState.success(productList: $productList)';
  }
...
abstract class _InitialData implements ProductListState {
  const factory _InitialData({required final List<ProductModel> productList}) =
      _$InitialDataImpl;
